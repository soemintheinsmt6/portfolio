...
const SKILLS = [
  ...
  { id: 'concepts', category: 'Concepts', items: ['Agile/Scrum', 'Clean Architecture', 'MVVM', 'MVC',  'SOLID Principles', 'Repository Pattern', 'Unit Testing'] },
  { id: 'tools-backend', category: 'Tools & Backend', items: ['Git', 'Firebase', 'RESTful API', 'GraphQL', 'CI/CD', 'Bitrise', 'GitHub Actions', 'Figma', 'Jira'] }
];
