          ...
          <div className="w-full md:w-1/2 text-center md:text-left">
            ...
            >
              <motion.a
                ...
                className={`flex items-center gap-2 px-6 py-3 ${theme.colors.button.gradient} rounded-full font-semibold ${theme.colors.text.primary} hover:shadow-lg transition-shadow`}
              >
              ...
              <motion.a
                ...
                className={`flex items-center gap-2 px-6 py-3 ${theme.colors.button.secondary} rounded-full font-semibold ${theme.colors.button.secondaryHover} transition-colors`}
              >
