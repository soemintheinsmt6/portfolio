...
export default function Hero({ onNavigate }) {
  ...
  return (
    <section id="home" className="pb-3xl pt-4xl md:pb-5xl md:pt-6xl">
      <Container>
        <Reveal>
          <h1 className="max-w-[15ch] font-display text-display-m md:text-[64px] md:leading-[64px] lg:text-display-xl">
            {site.headline.lead}
        ...
        <Reveal delay={0.1} className="mt-2xl flex flex-wrap items-center gap-lg">
